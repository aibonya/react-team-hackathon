...
import { Box,Card, CardActionArea, CardMedia, Container, IconButton, Typography } from '@mui/material';
...
export default function Cart() {
  ...
  return (
        ...
        <TableBody>
          ...
          cart?.products.map((row) => (
            <TableRow
              ...
              <Card style={{ borderRadius: "10px" , backgroundColor: "none !important" }} sx={{ maxWidth: 90 }}>
              <CardActionArea>
                <CardMedia
                  component="img"
                  height="130"
    ...
    <Box sx={{ '&:last-child td, &:last-child th': { border: 0 } }} style={{display: 'flex', justifyContent: "space-around", margin: "30px 20px"}}>
      <button onClick={() => navigate(`/pay-form`)} className='btn btn-secondary'>Go to buy</button>
